...
class BestSellerBooksRecyclerViewAdapter(
    ...
    inner class BookViewHolder(val mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        //val mBookButton = mView.findViewById<View>(id.buy_button) as Button
    ...
    override fun onBindViewHolder(holder: BookViewHolder, position: Int) {
        ...
        Log.d("BestSellerBooksFragment", position.toString())
        Log.d("BestSellerBooksFragment", book.toString())
        ...
        Glide.with(holder.mView)
            //.load(book.backdrop_path)
            .load("https://image.tmdb.org/t/p/w500" + book.backdrop_path)
            .centerInside()
...
//            val browserIntent = Intent(Intent.ACTION_VIEW, Uri.parse(book.backdrop_path))
